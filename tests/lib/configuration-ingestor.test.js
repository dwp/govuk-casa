...
describe("ConfigIngestor", () => {
  ...
  describe("validateMountUrl()", () => {
    ...
    it("throws if a trailing / is missing", () => {
      expect(() => validateMountUrl("/missing-slash")).to.throw(
        SyntaxError,
        "mountUrl must include a trailing slash (/)",
      );
    });
  });
  ...
  describe("validateI18nObject()", () => {
    it("should call the callback, passing a valid value, and return its result", () => {
      ...
      const testInput = {};
      expect(validateI18nObject(testInput, stubCallback)).to.equal(
        "test-response",
      );
  ...
  describe("validateI18nDirs()", () => {
    it("should throw an Error if the value is not an Array", () => {
      expect(() => validateI18nDirs("not an array")).to.throw(
        TypeError,
        "I18n directories must be an array (i18n.dirs)",
      );
    });
  ...
  describe("validateI18nLocales()", () => {
    it("should throw an Error if the value is not an Array", () => {
      expect(() => validateI18nLocales("not an array")).to.throw(
        TypeError,
        "I18n locales must be an array (i18n.locales)",
      );
    });
  ...
  describe("validateSessionObject()", () => {
    it("should call the callback, passing a valid value, and return its result", () => {
      const stubCallback = stub().returns("test-response");
      const testInput = {};
      expect(validateSessionObject(testInput, stubCallback)).to.equal(
        "test-response",
      );
      expect(stubCallback).to.be.calledOnceWithExactly(testInput);
    });
  ...
  describe("validateSessionCookiePath()", () => {
    it("should the default value if no value is specified", () => {
      expect(validateSessionCookiePath(undefined, "/default/")).to.equal(
        "/default/",
      );
    });
  ...
  describe("validateSessionCookieSameSite()", () => {
    it("should throw if a default flag value is not provided", () => {
      expect(() => validateSessionCookieSameSite(undefined)).to.throw(
        TypeError,
        "validateSessionCookieSameSite() requires an explicit default flag",
      );
      expect(() =>
        validateSessionCookieSameSite(undefined, "Lax"),
      ).to.not.throw();
    });
    ...
    it("should throw if an invalid default flag is provided", () => {
      ...
      expect(() =>
        validateSessionCookieSameSite("Strict", "BadValue"),
      ).to.throw(TypeError, err);
      expect(() => validateSessionCookieSameSite("Strict", [])).to.throw(
        TypeError,
        err,
      );
      expect(() =>
        validateSessionCookieSameSite("Strict", "Lax"),
      ).to.not.throw();
    });
    ...
    it("should throw if not provided with a valid value", () => {
      ...
      expect(() => validateSessionCookieSameSite("BadValue", false)).to.throw(
        TypeError,
        err,
      );
      expect(() => validateSessionCookieSameSite([], false)).to.throw(
        TypeError,
        err,
      );
  ...
  describe("validateSessionName()", () => {
    it("should throw a TypeError if the value is not a string", () => {
      expect(() => validateSessionName([])).to.throw(
        TypeError,
        "Session name must be a string (session.name)",
      );
    });
  ...
  describe("validateSessionSecret()", () => {
    it("should throw an ReferenceError if no value is specified", () => {
      expect(() => validateSessionSecret()).to.throw(
        ReferenceError,
        "Session secret is missing (session.secret)",
      );
    });
    ...
    it("should throw a TypeError if the value is not a string", () => {
      expect(() => validateSessionSecret([])).to.throw(
        TypeError,
        "Session secret must be a string (session.secret)",
      );
    });
  ...
  describe("validateSessionSecure()", () => {
    it("should throw an Error if the value is not defined", () => {
      expect(() => validateSessionSecure()).to.throw(
        Error,
    ...
    it("should throw a TypeError if the value is not a string", () => {
      expect(() => validateSessionSecure([])).to.throw(
        TypeError,
        "Session secure flag must be boolean (session.secure)",
      );
    });
  ...
  describe("validateSessionTtl()", () => {
    it("should throw a TypeError if the value is not an integer", () => {
      expect(() => validateSessionTtl([])).to.throw(
        TypeError,
        "Session ttl must be an integer (session.ttl)",
      );
    });
  ...
  describe("validateViews()", () => {
    it("should throw an Error if the value is not an Array", () => {
      expect(() => validateViews("not an array")).to.throw(
        TypeError,
        "View directories must be an array (views)",
      );
    });
  ...
  describe("validatePages", () => {
    ...
    it("throws if not an array", () => {
      expect(() => validatePages(null)).to.throw(
        TypeError,
        "Pages must be an array (pages)",
      );
    });
    ...
    it("throws if waypoint is invalid", () => {
      expect(() =>
        ...
        TypeError,
        "Page at index 0 is invalid: Waypoint must be a string",
      );
      ...
      expect(() =>
        ...
        SyntaxError,
        "Page at index 0 is invalid: Waypoint must not be empty",
      );
      ...
      expect(() =>
        ...
        SyntaxError,
        "Page at index 0 is invalid: Waypoint must contain only a-z, 0-9, -, _ and / characters",
      );
    });
    ...
    it("throws if view is invalid", () => {
      expect(() =>
        ...
        TypeError,
        "Page at index 0 is invalid: View must be a string",
      );
      ...
      expect(() =>
        ...
        SyntaxError,
        "Page at index 0 is invalid: View must not be empty",
      );
    ...
    describe("hooks", () => {
      it("throws if hooks are invalid", () => {
        expect(() =>
          ...
          TypeError,
          "Page at index 0 is invalid: Hooks must be an array",
        );
      });
      ...
      it("throws if hook name is invalid", () => {
        expect(() =>
          ...
          TypeError,
          "Page hook at index 0 is invalid: Hook name must be a string",
        );
        ...
        expect(() =>
          ...
          SyntaxError,
          "Page hook at index 0 is invalid: Hook name must not be empty",
        );
        ...
        expect(() =>
          ...
          SyntaxError,
          "Page hook at index 0 is invalid: Hook name must match either <scope>.<hookname> or <hookname> formats",
        );
      });
    });
    ...
    describe("field", () => {
      it("throws if fields are invalid", () => {
        expect(() =>
          ...
          TypeError,
          "Page at index 0 is invalid: Page fields must be an array (page[].fields)",
        );
        ...
        expect(() =>
          ...
          TypeError,
          'Page at index 0 is invalid: Page field at index 0 is invalid: Page field must be an instance of PageField (created via the "field()" function)',
        );
      });
    });
  });
  ...
  describe("validatePlan", () => {
    it("throws if not an instance of the Plan class", () => {
      expect(() => validatePlan(false)).to.throw(
        TypeError,
        "Plan must be an instance the Plan class (plan)",
      );
    });
  });
  ...
  describe("validateGlobalHooks()", () => {
    it("throws if not an array", () => {
      expect(() => validateGlobalHooks(false)).to.throw(
        TypeError,
    ...
    it("throws if hook name is invalid", () => {
      expect(() =>
        ...
        TypeError,
        "Global hook at index 0 is invalid: Hook name must be a string",
      );
      ...
      expect(() =>
        ...
        SyntaxError,
        "Global hook at index 0 is invalid: Hook name must not be empty",
      );
      ...
      expect(() =>
        ...
        SyntaxError,
        "Global hook at index 0 is invalid: Hook name must match either <scope>.<hookname> or <hookname> formats",
      );
    });
    ...
    it("throws if middleware is invalid", () => {
      expect(() =>
        ...
        TypeError,
        "Global hook at index 0 is invalid: Hook middleware must be a function",
      );
    });
    ...
    it("throws if path is invalid", () => {
      expect(() =>
        ...
        TypeError,
        "Global hook at index 0 is invalid: Hook path must be a string or RegExp",
      );
    });
  });
  ...
  describe("validateFormMaxParams()", () => {
    it("throws if not an integer", () => {
      expect(() => validateFormMaxParams(false)).to.throw(
        TypeError,
        "formMaxParams must be an integer",
      );
      expect(() => validateFormMaxParams(1024.5)).to.throw(
        TypeError,
        "formMaxParams must be an integer",
      );
    ...
    it("throws if below the minimum allowed value", () => {
      expect(() => validateFormMaxParams(9)).to.throw(
        RangeError,
        "formMaxParams must be at least 10",
      );
  ...
  describe("validateFormMaxBytes()", () => {
    it("throws if not a string or integer", () => {
      expect(() => validateFormMaxBytes(false)).to.throw(
        TypeError,
        "formMaxParams must be a string or an integer",
      );
    ...
    it("throws if below the minimum allowed value", () => {
      expect(() => validateFormMaxBytes(1023)).to.throw(
        RangeError,
        "formMaxBytes must be at least 1024 bytes (1KB)",
      );
      expect(() => validateFormMaxBytes("1023b")).to.throw(
        RangeError,
        "formMaxBytes must be at least 1024 bytes (1KB)",
      );
    });
  ...
  describe("validate global errorVisibility", () => {
    it("should be onsubmit as default value", () => {
      expect(validateErrorVisibility()).to.be.equal(
        CONFIG_ERROR_VISIBILITY_ONSUBMIT,
      );
    });
    ...
    it("should return a valid value", () => {
      expect(
        validateErrorVisibility(CONFIG_ERROR_VISIBILITY_ALWAYS),
    ...
    it("should throw an Error if the value is not constant or function", () => {
      expect(() => validateErrorVisibility("randome")).to.throw(
        TypeError,
  ...
  describe("validate page level errorVisibility", () => {
    it("should throw an Error if the errorVisibility value is not constant or function", () => {
      expect(() =>
        ...
        TypeError,
        "Page at index 0 is invalid: errorVisibility must be casa constant CONFIG_ERROR_VISIBILITY_ALWAYS | CONFIG_ERROR_VISIBILITY_ONSUBMIT or function",
      );
    });
