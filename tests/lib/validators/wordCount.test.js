...
describe("validators/wordCount", () => {
  it("should reject with a ValidationError", () => {
    ...
    expect(rule1("one two three four")).to.satisfy(
  ...
  it("should resolve for strings falling within the defined word count parameters", () => {
    ...
    expect(rule3("one two three four five six seven eight nine ten")).to.be
      .empty;
  });
  ...
  it("should reject for strings falling outside the defined word count parameters", () => {
    ...
    expect(rule2("one two three four five six seven eight nine ten")).to.not.be
      .empty;
    ...
    expect(rule3("one two three four five six seven eight nine ten eleven")).to
      .not.be.empty;
  });
  ...
  it("should use a specific error message if defined", () => {
    ...
    expect(
      rule1("one two three four five six seven eight nine ten eleven"),
    ).to.satisfy(([e]) => e.inline === "TEST MAX");
  });
