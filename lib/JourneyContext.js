...
class JourneyContext {
   ...
   * @return {JourneyContext} Constructed JourneyContext instance
   */
   ...
   * }
   *
   * @return {object} Identity object (see above)
   */
  getIdentity() {
   ...
   *
   * @return {boolean} True if this is the "default" journey context
   */
  isDefault() {
   ...
   * @return {string} Original ID if it's valid
   */
   ...
   * @param {object} session Request session
   * @param {string} id Context ID
   * @return {JourneyContext} The discovered JourneyContext instance
   */
   ...
   * @return {Array<JourneyContext>} The discovered JourneyContext instance
   */
