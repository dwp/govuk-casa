  ...
  sanitise(value) {
    if (value !== undefined) {
      return isObjectType(value) ? {
        dd: (['string', 'number'].includes(typeof value.dd) ? String(value.dd) : ''),
        mm: (['string', 'number'].includes(typeof value.mm) ? String(value.mm) : ''),
        yyyy: (['string', 'number'].includes(typeof value.yyyy) ? String(value.yyyy) : ''),
      } : Object.create(null);
    }
    return undefined;
  }
